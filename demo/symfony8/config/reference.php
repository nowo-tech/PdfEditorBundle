 ...
 * }
 * @psalm-type NowoPdfEditorConfig = array{
 *     default_profile?: scalar|Param|null, // Name of the profile used when none is requested (REQ-CFG-001) // Default: "default"
 *     profiles?: array<string, array{ // Default: {"default":{"python_binary":"python3","engine_script":"%kernel.project_dir%/vendor/nowo-tech/pdf-editor-bundle/engine/pdf_editor_engine.py","workspace_dir":"/tmp/nowo-pdf-editor","timeout":60.0,"idle_timeout":30.0,"max_upload_bytes":26214400,"render_dpi":144,"engine_mode":"client"}}
 *         python_binary?: scalar|Param|null, // Default: "python3"
 *         engine_script?: scalar|Param|null, // Default: "%kernel.project_dir%/vendor/nowo-tech/pdf-editor-bundle/engine/pdf_editor_engine.py"
 *         workspace_dir?: scalar|Param|null, // Default: "/tmp/nowo-pdf-editor"
 *         timeout?: float|Param, // Wall-clock timeout in seconds for the Python engine (REQ-RUNTIME-001) // Default: 60.0
 *         idle_timeout?: float|Param, // Idle timeout in seconds for the Python engine (REQ-RUNTIME-001) // Default: 30.0
 *         max_upload_bytes?: int|Param, // Default: 26214400
 *         render_dpi?: int|Param, // Default: 144
 *         engine_mode?: "client"|"python"|Param, // client = browser embedpdf/pdf-lib; python = PyMuPDF server engine // Default: "client"
 *     }>,
 *     security?: array{
 *         allow_unauthenticated?: bool|Param, // When true, skip role checks (demos only). // Default: false
 ...
 *     nowo_pdf_editor?: NowoPdfEditorConfig,
