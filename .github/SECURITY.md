...
We take the security of PdfEditorBundle seriously. If you believe you have found a security vulnerability, please report it privately:
...
- Type of issue (e.g., injection, XSS, auth bypass, webhook forgery, token leak, etc.)
